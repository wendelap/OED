...
mocha.describe('Compressed Readings', () => {
	...
	mocha.beforeEach(async () => {
		...
		await conn.tx(async t => {
			await new Meter(undefined, 'Meter', null, false, true, Meter.type.MAMAC, Timezone.type.CENTRAL).insert(t);
	...
	mocha.it('compresses readings for multiple meters at once', async () => {
		conn = testDB.getConnection();
		await new Meter(undefined, 'Meter2', null, false, true, Meter.type.MAMAC, Timezone.type.CENTRAL).insert(conn);
		await new Meter(undefined, 'Meter3', null, false, true, Meter.type.MAMAC, Timezone.type.CENTRAL).insert(conn);
