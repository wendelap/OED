...
async function setupGroupsAndMeters(conn) {
	...
	const meterA = new Meter(undefined, 'A', null, false, true, Meter.type.MAMAC, Timezone.type.CENTRAL);
	const meterB = new Meter(undefined, 'B', null, false, true, Meter.type.MAMAC, Timezone.type.CENTRAL);
	const meterC = new Meter(undefined, 'C', null, false, true, Meter.type.METASYS, Timezone.type.CENTRAL);
