...
mocha.describe('groups API', () => {
	...
	mocha.beforeEach(async () => {
		...
		meterA = new Meter(undefined, 'A', null, false, true, Meter.type.MAMAC, Timezone.type.CENTRAL);
		meterB = new Meter(undefined, 'B', null, false, true, Meter.type.MAMAC, Timezone.type.CENTRAL);
		meterC = new Meter(undefined, 'C', null, false, true, Meter.type.METASYS, Timezone.type.CENTRAL);
	...
	mocha.describe('modification API', () => {
		...
		mocha.describe('edit endpoint', () => {
			...
			mocha.it('allows adding a new child meter to a group', async () => {
				const conn = testDB.getConnection();
				const meterD = new Meter(undefined, 'D', null, false, true, Meter.type.MAMAC, Timezone.type.CENTRAL);
